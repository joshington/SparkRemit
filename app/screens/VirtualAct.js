...
const VirtualAct = ({route,navigation}) => {
        ...
        <View>
            ...
            <SafeAreaView style={styles.headerWrapper}>
                <View style={styles.header}>
                    ...
                    <View>
                        <Text style={styles.headerText}>create virtual account</Text>
                    </View>
            ...
            <TouchableOpacity style={{backgroundColor:"green",padding:hp('1%'),
               borderRadius:hp('3%'),marginTop:hp('9%'),width:wp('60%'),height:hp('6%'),alignSelf:"center"}}      
                onPress={() => {
                    setSubmitting(true)
                    fetch(`https://pregcare.pythonanywhere.com/api/wallet/create-virtual/?email=${email}&bvn=${bvn}`,{
                        method:'POST',
